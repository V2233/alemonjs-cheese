...
function Container({ children, style, copyright }) {
    ...
    const stl = {
        ...
        backgroundColor: cfg.model === "custom"
            ? undefined
            : cfg.model === "dark"
                ? "black"
                : "white",
...
function HeaderBox(data) {
    ...
    const style = {
        ...
        background: cfg.model == "dark"
            ? "rgba(0, 0, 0, 0.2)"
            : `rgba(255, 255, 255, ${cfg.mask_opacity})`,
        boxShadow: cfg.model == "dark"
    ...
    return (cfg.header_visible && (React.createElement("div", { className: "head_box", style: style },
        ...
        data.avatar && (React.createElement("div", { className: "avator_box" },
...
function Item({ children, color, classname, style, }) {
    ...
    return (React.createElement("div", { className: classname, style: {
            backgroundImage: cfg.model == "custom"
...
function Template(data) {
    ...
    return (React.createElement("html", { lang: "zh-CN", id: "__alemonjs" },
        ...
        React.createElement("body", { id: "root", style: {
                width: cfg.width,
