...
import fileUrl from "../../_virtual/_lvy-css_2.js";
import fileUrl$1 from "../../_virtual/_lvy-css_8.js";
...
function App({ data, theme }) {
	return /* @__PURE__ */ React.createElement(Template, {
		...
		}), curUserId > 3 ? `${curUserId}.` : "", l.maleNick || "？", /* @__PURE__ */ React.createElement("span", { className: "text-lg" }, "♡("), /* @__PURE__ */ React.createElement("img", { src: l.maleAvatar ?? `http://q2.qlogo.cn/headimg_dl?dst_uin=${l.man}&spec=5` }), /* @__PURE__ */ React.createElement("span", { className: "text-lg" }, ")人("), /* @__PURE__ */ React.createElement("img", { src: l.femaleAvatar ?? `http://q2.qlogo.cn/headimg_dl?dst_uin=${l.woman}&spec=5` }), /* @__PURE__ */ React.createElement("span", { className: "text-lg" }, ")♡"), l.femaleNick || "？");
	})))));
}
