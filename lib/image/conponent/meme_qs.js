...
function App({ data, theme }) {
	...
	return /* @__PURE__ */ React.createElement(Template, { styleSheet: [fileUrl] }, /* @__PURE__ */ React.createElement(Container, null, /* @__PURE__ */ React.createElement(HeaderBox, {
		...
		src: data.url
	})), /* @__PURE__ */ React.createElement(Item, { classname: "itemOne" }, /* @__PURE__ */ React.createElement("div", { className: "text-3xl font-bold text-wrap mb-2" }, /* @__PURE__ */ React.createElement("pre", { className: "whitespace-pre-wrap break-words" }, data.tip)), data.choices && data.choices.map((choice, index) => /* @__PURE__ */ React.createElement("div", {
