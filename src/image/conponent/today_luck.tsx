        ...
        <DataBox>
          <div className="list">
            ...
            <Item classname="itemOne">
              <div className="title">
                <div className="fortuneSummaryBox">
                  <FortuneFrame starcolor={data.starcolor} />
                </div>
              ...
              <div>
                ...
                <div className="title text-3xl" style={{ margin: '20px 0 20px 65px' }}>
                  <span className="star text-3xl" style={{ color: data.starcolor }}>
                    {data.luckyStar}
                  </span>
                </div>
              </div>
              ...
              <fieldset style={{ border: `2px dashed ${data.starcolor}` }}>
                ...
                <div className="luckyBox">
                  <div className="title mb-3 mr-3" style={{ textIndent: '2em' }}>
                    {data.luckData.signText}
                  </div>
                  <div
                    className="luckySignBox"
                    style={{
                      backgroundImage: `url(${join(publicPath, 'luckySignName', data.luckData.luckyCharm + '.png')})`,
                    }}
                  >
                    ...
                    <div className="qian" style={{ color: data.starcolor }}>
