    ...
    <div className="topdiv">
      <div>
        <img
          ...
          src={
            list.length >= 2 ? list[1].avatar : `https://q1.qlogo.cn/g?b=qq&s=0&nk=11451451451884}`
          }
        />
      ...
      <div>
        <img
          src={
            list.length >= 1 ? list[0].avatar : `https://q1.qlogo.cn/g?b=qq&s=0&nk=11451451451884}`
          }
        />
      ...
      <div>
        <img
          ...
          src={
            list.length >= 3 ? list[2].avatar : `https://q1.qlogo.cn/g?b=qq&s=0&nk=11451451451884}`
          }
        />
